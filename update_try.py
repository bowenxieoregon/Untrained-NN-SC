...
def optimize_s_dip2(X_true, W, X, Z1, C, R, model_path,ite_cu,alpha, patience, channels, layers, filters, lr, loop_count):
    """
    Arguments:
        W : Mask 
        X : sampled tensor
    ...
    decoded = get_net(input_depth, NET_TYPE, pad, upsample_mode, n_channels=1, act_fun='LeakyReLU', skip_n33d=256, skip_n33u=256, skip_n11=5, num_scales=6, downsample_mode='stride').to(device)
